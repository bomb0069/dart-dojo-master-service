...
Future<void> querySecondDatabase(SendPort p) async {
  ...
  print(
      'before inner insert into : ' + stopwatch.elapsedMilliseconds.toString());
  await db2.rawQuery('insert into product_dummy select * from product').then(
      (value) => print('after inner insert into : ' +
          stopwatch.elapsedMilliseconds.toString()));
...
Future<void> syncSecondDatabase() async {
  var stopwatch = Stopwatch();
  stopwatch.start();
  DatabaseService databaseService = DatabaseService();
